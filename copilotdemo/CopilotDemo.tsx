...
const downloads = {
  all: '/copilot-demo/CN-Print-Copilot-三段Demo现场演示包-v2.zip',
  demo1: '/copilot-demo/CN-Print-Copilot-Demo1-Copilot-Chat-v2.zip',
  demo2: '/copilot-demo/CN-Print-Copilot-Demo2-M365-Copilot-v2.zip',
  demo3: '/copilot-demo/CN-Print-Copilot-Demo3-Agent-Builder-v2.zip',
};
  ...
  return (
    <div className="min-h-screen bg-[#050816] text-slate-50 selection:bg-cyan-300 selection:text-slate-950">
      ...
      <main className="relative mx-auto max-w-7xl px-5 pb-24 pt-14 sm:px-8 sm:pt-20">
        <section className="grid gap-10 lg:grid-cols-[1.25fr_.75fr] lg:items-end">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
              这不是产品功能清单，而是一套可以直接投屏演示的讲师控制台：同一个案例，三次升级；每一段都带材料、提示词、通过标准与翻车备用路径。
            </p>
          </div>
        ...
        <section className="mt-14 flex flex-wrap gap-3 border-y border-white/10 py-5">
          ...
          <a href={downloads.demo1} download className="rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-cyan-300/50">Demo 1 素材</a>
          <a href={downloads.demo2} download className="rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-violet-300/50">Demo 2 素材</a>
          <a href={downloads.demo3} download className="rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-orange-300/50">Demo 3 素材</a>
        </section>
              ...
              <div className="grid gap-0 lg:grid-cols-[.9fr_1.1fr]">
                ...
                <div className="flex flex-col p-7 sm:p-9">
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    ...
                    <a href={demo.download} download className="rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:bg-white/10">下载本段材料</a>
                  </div>
        ...
        <section className="mt-16 rounded-[2rem] border border-cyan-300/20 bg-gradient-to-br from-cyan-300/10 via-blue-500/5 to-violet-500/10 p-8 text-center sm:p-12">
          ...
          <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-300">完整包包含三套输入材料、逐步演示卡、黄金参考答案、Agent 配置与测试、PPT 对照表和翻车备用路径。</p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <a href={downloads.all} download className="rounded-xl bg-cyan-300 px-6 py-3 text-sm font-black text-slate-950 transition hover:bg-cyan-200">下载三段 Demo 完整包</a>
