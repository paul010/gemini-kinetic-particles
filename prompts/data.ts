// Prompt library — sourced from PlexPt/awesome-chatgpt-prompts-zh (CC0).
// Chinese "act as ..." role prompts. Regenerate by re-fetching prompts-zh.json.
export interface PromptItem { act: string; prompt: string }
